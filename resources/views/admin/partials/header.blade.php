        ...
        <li class="dropdown user user-menu">  
          ...
          <ul class="dropdown-menu animated flipInX">
            <li class="user-body">
               ...
               <a class="dropdown-item" id="LogoutBtn" href="#" {{-- onclick="event.preventDefault();document.getElementById('LogoutForm').submit();" --}}><i class="ti-lock text-muted mr-2"></i> Logout</a>
