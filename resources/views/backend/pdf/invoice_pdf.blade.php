	  ...
	  <div class="row">
		...
		<div class="col-12">
		  <div class="page-header">
			<h2 class="d-inline"><span class="font-size-30">Invoice No: # {{ @$invoice->invoice_no }}</span></h2>
	  ...
	  <div class="row invoice-info">
		...
		<div class="col-sm-12 invoice-col mb-15">
			<div class="invoice-details row no-margin">
			  <div class="col-md-6 col-lg-3"><b>Customer Name: </b>{{ @$invoice->payment->customer->name }}</div>
			  <div class="col-md-6 col-lg-3"><b>Customer Mobile:</b> {{ @$invoice->payment->customer->mobile_no }}</div>
			  <div class="col-md-6 col-lg-3"><b>Customer Email:</b> {{ @$invoice->payment->customer->email }}</div>
	  ...
	  <div class="row">
		<div class="col-12 text-right">
			...
			<div>
				...
				<p>Discount Amount  :  ${{ @$invoice->payment->discount_amount }}</p>
				<p>Paid Amount  :  ${{ @$invoice->payment->paid_amount }}</p>
				<p>Due Amount  :  ${{ @$invoice->payment->due_amount }}</p>
			</div>
			<div class="total-payment">
				<h3><b>Total :</b> ${{ @$invoice->payment->total_amount }}</h3>
			</div>
