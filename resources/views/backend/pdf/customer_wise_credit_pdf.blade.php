...
@section('title')
	Customer Wise Credit Report (Pdf)
@endsection
@section('content')
	  ...
	  <div class="row">
		...
		<div class="col-12">
		  <div class="page-header">
			<h2 class="d-inline"><span class="font-size-30">Customer Wise Credit Report</span></h2>
		...
		<div class="col-12 table-responsive">
		  ...
		  <table class="table table-bordered">
			...
			@php
				$total_due_amount = 0;
			@endphp
			@foreach($customerWiseCredit as $row)
			<tr>
	  ...
	  <div class="row">
		<div class="col-12 text-right">
			<div class="total-payment">
				<h3><b>Grand Due Amount :</b> ${{ $total_due_amount }}</h3>
			</div>
		</div>
		<!-- /.col -->
	  </div>
