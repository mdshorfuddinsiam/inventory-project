	  ...
	  <div class="row">
		...
		<div class="col-12">
		  <div class="page-header">
			<h2 class="d-inline"><span class="font-size-30">Stock Product Wise Report</span></h2>
	  ...
	  <div class="row">
		<div class="col-12 table-responsive">
		  <table class="table table-bordered">
			...
			@php
				$buying_qty = \App\Models\Purchase::where('product_id', $product->id)->whereStatus('1')->sum('buying_qty');
				$selling_qty = \App\Models\InvoiceDetail::where('product_id', $product->id)->whereStatus('1')->sum('selling_qty');
			@endphp
			<tr>
