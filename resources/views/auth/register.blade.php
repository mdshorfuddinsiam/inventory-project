                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control pl-15 bg-transparent text-white plc-white" id="name" name="name" {{-- required="" --}} placeholder="Name" autofocus>
                                    </div>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <!-- <input type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name"> -->
                                        <input type="text" class="form-control pl-15 bg-transparent text-white plc-white" id="username"  name="username" {{-- required="" --}} placeholder="Username">
                                    </div>
                                    @error('username')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" class="form-control pl-15 bg-transparent text-white plc-white" id="email" name="email" {{-- required="" --}} placeholder="Email">
                                    </div>
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control pl-15 bg-transparent text-white plc-white" id="password" name="password" {{-- required="" --}} placeholder="Password">
                                    </div>
                                    @error('password')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control pl-15 bg-transparent text-white plc-white" id="password_confirmation" name="password_confirmation" {{-- required="" --}} placeholder="Password Confirmation">
                                    </div>
                                </div>
                                  <div class="row">
                                    <!-- <div class="col-12">
