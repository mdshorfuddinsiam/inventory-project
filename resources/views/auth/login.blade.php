                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control pl-15 bg-transparent text-white plc-white" id="username" type="text" name="username" required="" placeholder="Username" value="{{ old('username') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control pl-15 bg-transparent text-white plc-white" id="password" type="password" name="password" required="" placeholder="Password" autocomplete="current-password">
                                    </div>
                                </div>
                                  <div class="row">
                                    <div class="col-6">
